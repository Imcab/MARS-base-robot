...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain
    implements Subsystem, ICommandSwerveDrivetrain {
      ...
      DriverStation.getAlliance()
          .ifPresent(
              allianceColor -> {
                ...
                m_hasAppliedOperatorPerspective = true; // TODO: ALIANZA AZUL
              });
    }
  ...
  public void aproachY() {
    ...
    setControl(
        SwerveRequestFactory.simpleDriveRequest()
            .withVelocityX(xSpeed)
            .withVelocityY(0)
            .withRotationalRate(0));
  }

  /** MODO 1: AUTO-DOCK (El robot hace todo) Se acerca al tag y se alinea usando RobotCentric. */
  ...
  /**
   * MODO 2: AIM ASSIST (Para Teleop) El piloto controla X/Y, el robot controla el giro hacia el
   * tag.
   *
  ...
  public void driveFacingTag(double xSpeed, double ySpeed) {
    ...
    Rotation2d targetHeading =
        hasTarget ? currentHeading.minus(Rotation2d.fromDegrees(tx)) : currentHeading;

    // Usamos el request de Aim de la Factory
    setControl(
        SwerveRequestFactory.aimRequest()
            .withVelocityX(xSpeed)
